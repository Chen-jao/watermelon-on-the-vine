...
def auInit():
    ...
    #hit_au = pygame.mixer.Sound("")

#循环播放背景音乐
def roundBgSound(music_play):
    if not music_play:
        bg_sound.playSound()
        music_play = True
...
#背景音乐
music_play = False #创建一个全局变量播放背景音乐
#bg_sound.playSound()
while True:
    #帧数50
    frame_time.tick(60)
    ...
    for event in pygame.event.get():
        ...
        if event.type == MOUSEBUTTONDOWN:
            mouse_pressed_array = pygame.mouse.get_pressed()
    ...
    music_play = roundBgSound(music_play)
